...
Devise.setup do |config|
  ...
  #config.omniauth :facebook, "661594500524816", "f69d1dfbe8d7ef84746831634d99eacc", :strategy_class => OmniAuth::Strategies::Facebook, :scope => 'email,user_birthday,manage_pages,publish_stream,read_stream,friends_location,friends_birthday,friends_work_history,friends_education_history,friends_about_me'
